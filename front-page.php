...
<<<<<<< HEAD
    <div class="equipe">
        <div class="equipe_1">
            <span>KARINA</span>
            <img src="<?php echo get_template_directory_uri(); ?>assets/image/Avatar-karina.png" alt="" class="">
            <span>Co-fondatrice <br> Web Designer</span>
        </div>
        <div class="equipe_2">
            <span>JEAN-BAPTISTE</span>
            <img src="<?php echo get_template_directory_uri(); ?>assets/image/Avatar-JB.png" alt="">
            <span>Co-fondatrice <br> Web Designer</span>
        </div>
        <div class="equipe_3">
            <span>CHLOÉ</span>
            <img src="<?php echo get_template_directory_uri(); ?>assets/image/Avatar-chloé.png" alt="">
            <span>Co-fondatrice <br> Web Designer</span>
        </div>
    </div>
=======
